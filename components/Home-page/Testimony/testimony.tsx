...
const styleTestimonyText =
  "font-eudoxusRegular text-sm sm:text-base md:text-lg leading-[25px] sm:leading-[32px] text-grey";
            ...
            <div className="mx-auto rounded bg-whitebasic p-10 space-y-10 max-w-2xl mb-10">
              ...
              <div className={styleContent}>
                <img
                  ...
                  alt="Person picture"
                />
                <p className={styleName}>Janne Cooper</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="mx-auto rounded bg-whitebasic p-10 space-y-10 max-w-2xl mb-10">
              ...
              <div className={styleContent}>
                <img
                  ...
                  alt="Person picture"
                />
                <p className={styleName}>Isabella Cole</p>
              </div>
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="mx-auto rounded bg-whitebasic p-10 space-y-10 max-w-2xl mb-10">
              ...
              <div className={styleContent}>
                <img
                  ...
                  alt="Person picture"
                />
                <p className={styleName}>Jonathan Garnes</p>
              </div>
            </div>
          </SwiperSlide>
        </Swiper>

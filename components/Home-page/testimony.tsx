    ...
    return (
        <div className="w-full h-full grid justify-items-center px-16 xl:px-32 2xl:px-52 pb-32 bg-white">
            <div className="grid justify-items-center space-y-5">
                <h3 className="font-eudoxusBold text-yellow text-[18px]">Testimonials</h3>
                <h2 className="font-eudoxusBold text-black text-[44px] leading-[57px]">What our customer say</h2>
                <div className="font-eudoxusRegular text-[18px] text-grey pb-10">
                ...
                <div className="rounded bg-whitebasic p-10 space-y-10 max-w-2xl">
                    <p className="font-eudoxusRegular text-[18px] text-grey">

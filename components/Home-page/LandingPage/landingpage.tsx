        ...
        <div className="w-full h-full px-[24px] sm:px-16 xl:px-32 2xl:px-52 py-32 md:py-52 bg-white">
            <div className="h-full grid justify-items-center xl:container xl:mx-auto">
                <div className="grid justify-items-center max-w-3xl space-y-10">
                    <h1 
                        className="w-full font-eudoxusBold text-4xl sm:text-5xl md:text-[64px] leading-snug sm:leading-snug md:leading-[83px] text-[#151411] text-center" 
                    ...
                    >   
                        <div className="relative w-[240px] sm:w-[350px] md:w-full">
                            ...
                            <input 
                                type="search" 
                                className="w-[240px] sm:w-[350px] font-eudoxusMedium block p-4 pl-10 md:w-[600px] text-sm md:text-lg text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:border-green3 focus:ring-green3 focus:ring-1" 

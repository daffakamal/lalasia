                ...
                <div className="grid justify-items-center max-w-3xl space-y-10">
                    ...
                    <form>   
                        <div className="relative z-20">
                            ...
                            <input type="search" className="font-eudoxusMedium block p-4 pl-10 w-[600px] text-[18px] text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:border-green3 focus:ring-green3 focus:ring-1" placeholder="Search property" />
                            <button type="submit" className="font-eudoxusMedium text-white absolute right-2.5 bottom-2.5 bg-green hover:bg-green2 font-medium rounded-lg text-[18px] px-4 py-2 pointer-event">Search</button>
                        </div>
                    </form>
                </div>
            </div>

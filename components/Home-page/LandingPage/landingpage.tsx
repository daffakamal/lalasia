                ...
                <div className="grid justify-items-center max-w-3xl space-y-10">
                    ...
                    <form className="z-30" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="400">   
                        <div className="relative">
                            ...
                            <button type="submit" className="font-eudoxusMedium text-white absolute right-2.5 bottom-2.5 bg-green hover:bg-green2 font-medium rounded-lg text-base md:text-lg px-4 py-2 pointer-event">
                                Search
                            </button>
                        </div>
                    </form>

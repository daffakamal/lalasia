                ...
                <div className="grid justify-items-center max-w-3xl space-y-10">
                    ...
                    <form>   
                        <div className="relative z-20">
                            ...
                            <button type="submit" className="font-eudoxusMedium text-white absolute right-2.5 bottom-2.5 bg-green hover:bg-green2 font-medium rounded-lg text-base md:text-lg px-4 py-2 pointer-event">Search</button>
                        </div>
                    </form>
                </div>
            </div>

    ...
    return (
        ...
        <div className="w-full h-full grid content-center px-16 xl:px-32 2xl:px-52 pb-32 bg-white">
            <div className="space-y-3">
                <h3 className="font-eudoxusBold text-yellow text-base md:text-lg">Benefits</h3>
                <div className="flex flex-col md:flex-row gap-6 md:gap-[308px]">
                    <div className="font-eudoxusBold text-black text-[40px] md:text-[44px] leading-[57px]">
                        <h2>Benefits when using our services</h2>
                    </div>
                    <div className="font-eudoxusRegular text-base md:text-lg text-grey">

...
const styleSubContent =
  "w-full flex gap-x-5 rounded hover:bg-greenLight text-white hover:text-black p-4 cursor-pointer";
              ...
              <div className="w-full grid justify-items-start content-start gap-y-5">
                <div className="w-full flex gap-x-5 bg-green2 rounded-xl border-2 border-orangeLight p-3 cursor-pointer">
                  ...
                  <div className="grid space-y-1">
                    <p className={styleWord}>Username</p>
                ...
                <div className={styleSubContent}>
                  ...
                  <p className={styleWord}>Dashboard</p>
                </div>
                <div className={styleSubContent}>
                  <ListBulletIcon className="w-6" />
                  <p className={styleWord}>Order History</p>
                </div>
                <div className={styleSubContent}>
                  <ShoppingCartIcon className="w-6" />
                  <p className={styleWord}>Transactions List</p>
                </div>
                <div className={styleSubContent}>
                  <BookmarkIcon className="w-6" />
                  <p className={styleWord}>Saved Items</p>
                </div>
                <div className={styleSubContent}>
                  <UserCircleIcon className="w-7" />
                  <p className={styleWord}>Update Profile</p>
                </div>
                <div className={styleSubContent}>
                  <ChatBubbleLeftRightIcon className="w-6" />
                  <p className={styleWord}>Contact Support</p>
                </div>
              </div>
            </div>
            <Link href="/">
              <div className="flex mx-auto w-fit mt-20 ml-0 gap-x-4 rounded-xl hover:bg-greenLight px-5 py-3 cursor-pointer">
                ...
                <a className="font-eudoxusMedium text-black">Back to Home</a>
              </div>
            </Link>
          </div>

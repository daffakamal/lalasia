function OurMission() {
  const styleNumber =
    "font-eudoxusBold text-black text-[22px] sm:text-[40px] md:text-[44px]";
  const styleWord =
    "font-eudoxusMedium text-grey text-sm sm:text-base md:text-lg";
  ...
  const styleTitle =
    "font-eudoxusBold text-sm sm:text-base md:text-lg xl:text-2xl text-black leading-[25px] sm:leading-[32px]";
            ...
            >
              <div className={styleContent}>
                ...
                <div className={styleSubContent}>
                  <h3 className={styleTitle}>24/7 Supports</h3>
              ...
              <div className={styleContent}>
                ...
                />
                <div className={styleSubContent}>
                  <h3 className={styleTitle}>Free Consultation</h3>
                  <p className={styleDescription}>
              ...
              <div className={styleContent}>
                ...
                />
                <div className={styleSubContent}>
                  <h3 className={styleTitle}>Overall Guarantee</h3>
                  <p className={styleDescription}>

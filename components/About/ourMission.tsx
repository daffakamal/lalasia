                        ...
                        <div className="grid space-y-10 justify-items-start">
                            <div className="flex gap-x-10">
                                <img 
                                    ...
                                    className="w-[62px] pointer-events-none"
                                />
                                <div className="grid space-y-3">
                                    <h3 className="font-eudoxusBold text-sm sm:text-base md:text-lg xl:text-2xl text-black leading-[25px] sm:leading-[32px]">
                                        24/7 Supports
                                    </h3>
                                    <p className="font-eudoxusRegular text-sm sm:text-base md:text-lg text-grey leading-[25px] sm:leading-[32px]">

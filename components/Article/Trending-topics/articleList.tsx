...
const styleContainer =
  "flex items-center space-x-8 p-4 duration-200 hover:bg-orangeLight hover:rounded-xl cursor-pointer";
const styleH5 =
  "font-eudoxusMedium text-[12px] sm:text-[14px] md:text-[16px] text-grey";
const styleH4 =
...
const styleWriter =
  "w-1/5 font-eudoxusBold text-[12px] md:text-[14px] text-black";
const styleDate =
  "invisible lg:visible font-eudoxusMedium text-[14px] text-grey";
...
export default function ArticleList() {
  return (
    ...
    >
      <div className={styleContainer}>
        ...
        <div className={styleContent}>
          ...
          <p className={styleP}>
            ...
            home design. Interiordesign.id, If by chance your house has enough
            space or space.
          </p>
      ...
      <div className={styleContainer}>
        <img src="/images/Article/Rectangle 46.svg" className={styleImg} />
        <div className={styleContent}>
      ...
      <div className={styleContainer}>
        <img src="/images/Article/Rectangle 47.svg" className={styleImg} />
        <div className={styleContent}>

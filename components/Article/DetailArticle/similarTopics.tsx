...
const styleH4 =
  "font-eudoxusBold text-[16px] sm:text-[22px] md:text-[24px] 2xl:text-[26px] text-black";
...
const styleWriter =
  "w-full lg:w-1/4 2xl:w-2/12 font-eudoxusBold text-[12px] md:text-[14px] text-black";
const styleDate =

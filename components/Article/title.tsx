    ...
    return (
        <div className="w-full h-full bg-white">
            <div className="grid justify-items-center px-[24px] sm:px-16 xl:px-32 2xl:px-52 pt-28 md:pt-32 lg:pt-52">
                <div className="grid justify-items-center xl:container xl:mx-auto" data-aos="fade-up" data-aos-duration="2000">
                    <h2 className="font-eudoxusBold text-4xl sm:text-5xl md:text-[64px] md:leading-[83px] text-[#151411] text-center pb-5" data-aos="fade-zoom-in" data-aos-duration="2000">
                        Article
                    </h2>
                    <div className="font-eudoxusRegular text-sm sm:text-base md:text-lg text-grey leading-[25px] sm:leading-[32px] text-center pb-20" data-aos="fade-zoom-in" data-aos-duration="2000">
                    ...
                    <Link href="#!">
                        <div className="grid justify-items-center z-20 cursor-pointer duration-200 hover:-translate-y-6 -mt-20 md:-mt-24 lg:-mt-36 drop-shadow-lg">
                            <div className="rounded bg-whitebasic p-7 lg:p-10 2xl:p-14 space-y-4 lg:space-y-7 max-w-lg lg:max-w-5xl" data-aos="fade-up" data-aos-duration="1500">

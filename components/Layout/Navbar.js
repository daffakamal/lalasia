...
function Navbar() {
  ...
  const styleTextNav =
    "font-eudoxusMedium text-sm sm:text-base md:text-lg cursor-pointer text-black hover:text-green px-3 py-2";
          ...
          <div className="w-full flex items-center justify-between">
            ...
            <div className="hidden lg:block">
              <div className="flex space-x-2 lg:space-x-6 2xl:space-x-11">
                ...
                <Link href="/Products">
                  <a className={styleTextNav}>Product</a>
                </Link>
                <Link href="/Services">
                  <a className={styleTextNav}>Services</a>
                </Link>
                <Link href="/Article">
                  <a className={styleTextNav}>Article</a>
                </Link>
                <Link href="/About">
                  <a className={styleTextNav}>About Us</a>
                </Link>
              </div>
            </div>

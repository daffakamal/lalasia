...
function Footer() {
  const styleContent =
    "font-eudoxusMedium cursor-pointer text-black hover:text-green text-sm sm:text-base md:text-lg";
  ...
  return (
    <div className="w-full h-full grid content-center px-7 sm:px-16 xl:px-32 2xl:px-52 py-28 bg-white">
      ...
      <div className="grid grid-rows-4 lg:grid-rows-1 grid-cols-none lg:grid-cols-5 xl:container xl:mx-auto pt-20">
        ...
        <div className="grid content-start col-span-1 sm:col-span-3 sm:flex sm:flex-wrap row-span-3 lg:row-span-1 justify-end lg:col-span-2 sm:pt-20 lg:pt-0">
          <div className="grid space-y-5">
            <p className="font-eudoxusBold cursor-pointer text-black text-sm sm:text-base md:text-lg">
              Product
            </p>
            <Link href="#!">
              <a className={styleContent}>New Arrivals</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>Best Selling</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>Home Decor</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>Kitchen Set</a>
            </Link>
          </div>
          <div className="grid space-y-5 pt-10 sm:pt-0">
            ...
            <Link href="#!">
              <a className={styleContent}>Catalog</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>Blog</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>FAQ</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>Pricing</a>
            </Link>
          </div>
          <div className="grid content-start space-y-5 pt-10 sm:pt-0">
            ...
            <Link href="#!">
              <a className={styleContent}>Facebook</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>Instagram</a>
            </Link>
            <Link href="#!">
              <a className={styleContent}>Twitter</a>
            </Link>
          </div>
        </div>
      </div>

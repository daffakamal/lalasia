...
export default function CardImg() {
  return (
    <div
      className="grid grid-cols-1 lg:grid-cols-2 space-y-10 lg:space-y-0 lg:space-x-10 pt-20"
      data-aos="fade-up"
            ...
            <div className="h-full flex items-end px-[24px] sm:px-16 py-[40px]">
              <div className="grid text-white space-y-2">
                ...
                <p className="font-eudoxusRegular text-greyBorder text-xs sm:text-lg md:text-lg w-full md:w-3/5 lg:w-4/5 xl:w-full 2xl:w-7/12">
                  We start renovating our client bedroom with minimalist concept
                  and using combination white and wooden material
                </p>
                <Link href="#!">

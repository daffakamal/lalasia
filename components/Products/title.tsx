...
function Title () {
    return (
        <div className="w-full h-full bg-white">
            <div className="grid justify-items-center px-[24px] sm:px-16 xl:px-32 2xl:px-52 pt-28 md:pt-32 lg:pt-52" data-aos="fade-up" data-aos-duration="2000">
                <div className="grid justify-items-center xl:container xl:mx-auto space-y-5" data-aos="fade-zoom-in" data-aos-duration="2000">
